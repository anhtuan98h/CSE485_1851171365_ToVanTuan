            ...
            <div id="page-inner">
                <div class="row">
					...
					<img src="assets/img/logo.PNG" alt="logo" title="logo">  
                     <h2 class="text-info text-center">Quản lý bài viết</h2>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
                ...
                if ($current_page > 1 && $total_page > 1){
                	echo '<li><a href="post.php?page='.($current_page-1).'">Trước</a></li>';
                }
                ...
                if ($current_page < $total_page && $total_page > 1){
                	echo '<li><a href="post.php?page='.($current_page+1).'">Sau</a></li>';
                }
